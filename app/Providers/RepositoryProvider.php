...
use App\Repositories\OrderRepository\OverviewReportReportRepository;
use App\Repositories\OrderRepository\RevenueReportReportRepository;
...
class RepositoryProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(OverviewReportRepoInterface::class, OverviewReportReportRepository::class);
        $this->app->bind(RevenueReportRepoInterface::class, RevenueReportReportRepository::class);
    }
